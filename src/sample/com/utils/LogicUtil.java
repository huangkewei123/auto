...
public class LogicUtil {
     ...
     * @return
     */
    public static String getLogicType(String lineText) {
        //如果包含括号，则进入以下逻辑
     ...
     * @return
     */
    public static boolean getLogic(String lineText) {
        //如果包含括号，则进入以下逻辑
        if(lineText.trim().equals(RobotConstants.ENDIF_TAG))
    ...
    /*public static boolean isLogicalJudgment(String lineText,Integer currentLine ,String logicFlag) throws SubException {
        ...
        }else if(lineText.contains(RobotConstants.PARAM_START_TAG) && StringUtils.isNotEmpty(logicFlag)
                && (logicFlag.equals(RobotConstants.IF_TAG)
                || logicFlag.equals(RobotConstants.ELIF_TAG)
                || logicFlag.equals(RobotConstants.WHILE_TAG))){
